...
You can be trusted, but here it is for completeness' sake:
...
* **No Pathfinder Restricted options.**
...
* **No undead archetypes:** Ghost, Ghoul, Lich, Mummy, Zombie, Vampire, Necrologist, Undead Master, Clockwork Reanimator.
* **No Exemplar archetype.**
* **No Rare archetypes without prior GM approval.**

#### Rare Archetypes that are Pre-Approved
...
* Crystal Keeper
* Cultivator
* Runelord (all schools except Lust)
* Sanguimancer
* Scions of Domora
* Chronoskimmer

#### Rare Archetypes that are Not Allowed
...
I encourage you to have good skill coverage across the party. Please make sure you can check off the following:

* [ ] Everyone has at least some ability to swim (trained in Acrobatics is a good minimum).
* [ ] The party has at least one character who can craft magic items.
* [ ] The party has at least one character who can pilot or navigate a ship. See [Sailing Ship](https://2e.aonprd.com/Vehicles.aspx?ID=79) and [Raft](https://2e.aonprd.com/Vehicles.aspx?ID=77) for examples of required skills. You can probably get an NPC to help, but they will not be as good as a trained PC.
